package com.ciaoshen.sia4.ch04.aop_before_after_43;
...
import com.ciaoshen.sia4.ch04.aop_before_after_43.config.AopBeforeAfterConfig;
// java utils
...
@ContextConfiguration(classes=AopBeforeAfterConfig.class)
public class TestAopBeforeAfter {

    @Autowired
    private Performance performance;

    @Test
    public void testAopBeforeAfter() {
